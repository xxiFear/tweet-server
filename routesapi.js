...
module.exports = [
  ...
  { method: 'POST', path: '/api/tweets/multiple/{multipleTweets}', config: TweetsApi.deleteMultiple },
  ...
  { method: 'POST', path: '/api/users/multiple/{multipleUsers}', config: UsersApi.deleteMultiple },
